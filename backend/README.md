...
## Project Structure
    ...
    ├── testapiautocatalog_116463  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_116463`
...
2. Clone this repo and `cd testapiautocatalog_116463`
